    ...
    <div
        ...
        <div class="form-box login">
            ...
            <form action="auth_process.php" method="POST">
                ...
                <button type="sumbit" name="login_btn" class="btn">Login</button>
        ...
        <div class="form-box register">
            ...
            <form action="auth_process.php" method="POST">
                ...
                <button type="sumbit" name="register_btn" class="btn">Register</button>
